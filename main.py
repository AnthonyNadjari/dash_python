        ...
        dbc.Nav(
            [
                dbc.NavLink('Autocall (Athena/Phoenix)',
                            ...
                            id='page-1-link',
                            active='exact'),
                dbc.NavLink('Display Data',
                            href='/page-2',
                            id='page-2-link',
                            active='exact'),

                dbc.NavLink('Download PDF',
                            href='/page-3',
                            id='page-3-link',
                            active='exact'),
...
def render_page_content(pathname):
    if pathname in ["/","/page-1"]:
        ...
        return display_stocks.stocks_layout
    elif pathname == '/page-3':
        return dl_latex_interface.layout_latex
...
if __name__=="__main__":
    app.run_server(debug=False,port=3326)
